...
//data
import {links,isloggedIn,bgColor} from './index'
...
function App() {
  const postsUrl = 'http://localhost:3000/posts/getAllposts';
  ...
  return (
    <>  
      <Header links={links} isloggedIn={isLogged} bgColor={bgColor} changeAuth = {() => changeAuthState()}/>
